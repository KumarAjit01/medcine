...
const ADMIN_EMAIL = "test@example.com"; // Defined for clarity
    ...
    if (result.success && result.user) {
      ...
      if (result.user.email === ADMIN_EMAIL) {
        router.push('/admin'); // Redirect admin to admin dashboard
         ...
         // If a non-admin somehow logs in here, treat them as a regular user
        toast({
          title: "Access Notice",
          description: "You have logged in, but this is an admin portal. Redirecting to homepage.",
          variant: "default",
        });
    ...
    <div className="flex justify-center items-center py-8">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Access the Online Medicine Ordering System dashboard.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
